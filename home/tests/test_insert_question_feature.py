        ...
        @pytest.mark.parametrize(
            ...
            [
                ...
                (
                    ...
                    2,
                    "Question in History",
                    "How many wars Israel had?",
                    datetime(2022, 4, 7, 12, 59, 55, 4, tzinfo=pytz.UTC),
                    1,
                    None,
                    Grade.GRADE8,
                    2,
        ...
        @pytest.mark.parametrize(
            ...
            [
                (
                    ...
                    "Invalid data. Book number must be between 1-999.",
                ),
                    ...
                    (
                        {
                            ...
                            "subject": 1,
                            "content": "How much is it 1+1?",
                            "tags_": "aaaaaaaaaaaaaaaaaaaaaaaa",
                            "grade": Grade.GRADE7,
                        }
                    ),
                    """Invalid data.
                    ...
                    (
                        {
                            ...
                            "subject": 1,
                            "content": "How much is it 1+1?",
                            "tags_": "beyond_01, beyond_02, beyond_03, beyond_04, beyond_05, beoynd_06",
                            "grade": Grade.GRADE7,
                        }
                    ),
                    """Invalid data.
